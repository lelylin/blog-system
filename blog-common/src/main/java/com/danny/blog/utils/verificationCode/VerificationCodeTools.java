package com.danny.blog.utils.verificationCode;
...
public class VerificationCodeTools {
    ...
    public void getRandcode(HttpServletRequest request, HttpServletResponse response) {
        ...
        g.setFont(new Font("Times New Roman", Font.ROMAN_BASELINE, 21));//字体大小
        ...
        try {
            ...
            logger.error("将内存中的图片通过流动形式输出到客户端失败");
            e.printStackTrace();
        }
